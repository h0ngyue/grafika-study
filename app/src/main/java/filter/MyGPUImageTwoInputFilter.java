...
public class MyGPUImageTwoInputFilter extends MyGPUImageFilter {
    ...
    public MyGPUImageTwoInputFilter(String fragmentShader) {
        this(VERTEX_SHADER, fragmentShader);
    }

    public MyGPUImageTwoInputFilter(String vertexShader, String fragmentShader) {
