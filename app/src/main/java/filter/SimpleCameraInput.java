...
public class SimpleCameraInput extends GPUImageFilter {
    ...
    public SimpleCameraInput() {
        super(OpenGlUtils.readShaderFromRawResource(R.raw.default_vertex), OpenGlUtils.readShaderFromRawResource(R.raw.default_fragment_simple));
