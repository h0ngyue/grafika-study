...
public class OpenGlUtils {
	...
	private static class ContextFactory implements GLSurfaceView.EGLContextFactory {
		...
		public EGLContext createContext(
			...
			Timber.d("creating OpenGL ES " + glVersion + " context");
	...
	public static String readShaderFromRawResource(final int resourceId){
		final InputStream inputStream = BeautyCamera.context.getResources().openRawResource(
				resourceId);
    ...
    public static Bitmap drawToBitmapByFilter(Bitmap bitmap, MyGPUImageFilter filter,
